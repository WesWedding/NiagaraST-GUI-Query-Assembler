...
public class Operator2 {
    ...
    public Element generateOperatorXML(){
        Element op = new Element(name);
        op.setAttribute(new org.jdom.Attribute("id", "scan"));
        op.setAttribute(new org.jdom.Attribute("attrs", "bidderrid,amt"));
        op.setAttribute(new org.jdom.Attribute("filename", "/stash/datalab/datastreams-student/streamdata/bids_very_small.xml"));
        return op;
    }
